...
<div class="space-y-8">
	<div class="flex items-center">
		...
		<div class="ml-4 space-y-1">
			...
			<p class="text-muted-foreground text-sm">NFT ID: 03e838ue9812</p>
		</div>
		<div class="ml-auto font-medium">+KT 1,999.00</div>
	</div>
	<div class="flex items-center">
		...
		<div class="ml-auto font-medium">+KT 39.00</div>
	</div>
	<div class="flex items-center">
		<Avatar.Root class="h-9 w-9">
		...
		<div class="ml-auto font-medium">+KT 299.00</div>
	</div>
	<div class="flex items-center">
		<Avatar.Root class="h-9 w-9">
		...
		<div class="ml-auto font-medium">+KT 99.00</div>
	</div>
	<div class="flex items-center">
		<Avatar.Root class="h-9 w-9">
