<script lang="ts" >
  ...
  <div class="p-2 max-w-xs lg:max-w-md mx-auto border-[3.5px] border-zinc-400 bg-white shadow-md xl:shadow-lg rounded-lg overflow-hidden min-h-[650px] max-h-[650px] relative">
    <Carousel.Root>
      <Carousel.Content>
