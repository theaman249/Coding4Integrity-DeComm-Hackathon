<script lang="ts">
	...
	const { form, errors, enhance, constraints, capture, restore } = superForm(defaults(zod(newContactSchema)), {
        SPA: true,
        ...
        <div class="block text-center">
            ...
            <form method="POST" use:enhance>
                <div class="grid w-full max-w-sm items-center gap-1.5 text-start mt-5">
                    ...
                    <Input type="text" id="fullName" name="fullName" bind:value={$form.fullName} {...$constraints.fullName} />
                    {#if $errors.fullName}
