...
<div class="grid grid-cols-12 mt-22 pt-20 lg:pt-0 xl:mt-0 bg-zinc-50 w-full">
    {#if !posts}
    <div class="col-span-12 grid grid-cols-12 justify-center items-center w-full h-screen">
        <div class="col-span-12 flex h-full w-full justify-center items-center text-3xl lg:text-7xl font-medium animate-pulse-custom">
            Loading Items...
        </div>
    </div>
    ...
    >
        {#each converted as post, i}
            <div class="col-span-12 bg-zinc-50 md:col-span-6 lg:col-span-3 w-full h-1/6 border-zinc-300 {i >=4 ? "2xl:mt-10" : "2xl:mt-44"}"
